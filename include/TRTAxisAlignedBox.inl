...
namespace TinyRT
{
    ...
    {
        m_min.x = std::min( m_min.x, rPoint.x );
        m_min.y = std::min( m_min.y, rPoint.y );
        m_min.z = std::min( m_min.z, rPoint.z );

        m_max.x = std::max( m_max.x, rPoint.x );
        m_max.y = std::max( m_max.y, rPoint.y );
        m_max.z = std::max( m_max.z, rPoint.z );
    }
    ...
    {
        m_min.x = std::min( m_min.x, rBox.Min().x );
        m_min.y = std::min( m_min.y, rBox.Min().y );
        m_min.z = std::min( m_min.z, rBox.Min().z );
        m_max.x = std::max( m_max.x, rBox.Max().x );
        m_max.y = std::max( m_max.y, rBox.Max().y );
        m_max.z = std::max( m_max.z, rBox.Max().z );
    }
