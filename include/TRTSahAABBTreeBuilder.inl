...
namespace TinyRT
{
    ...
    template< typename ObjectSet_T, typename CostFunction_T >
    SahAABBTreeBuilder<ObjectSet_T, CostFunction_T>::SahAABBTreeBuilder( const CostFunction_T& rCost  ) 
        : m_costFunc(rCost)
    {
    }
    ...
    uint32 SahAABBTreeBuilder<ObjectSet_T, CostFunction_T>::BuildTree( ObjectSet* pObjects, AABBTree_T* pTree )
    {
        ...
        uint32 nDepth = BuildRecurse( objectsByAxis, nObjects, pTree, pRoot, globalBox, 0 );
    ...
    uint32 SahAABBTreeBuilder<ObjectSet_T, CostFunction_T>::BuildQuadAABBTree( ObjectSet* pObjects, QAABBTree_T* pTree )
    {
        ...
        int nAxis0 = SplitObjects( objectsByAxis, globalBox, nObjects, objectsRight, nObjectsLeft, nObjectsRight, leftBox, rightBox );
        ...
        else
        {
            ...
            uint32 nDepthLeft = BuildQAABBRecurse_Odd( objectsByAxis, nObjectsLeft, pTree, pRoot, 0, leftBox, 0, nAxis1 );
            uint32 nDepthRight = BuildQAABBRecurse_Odd( objectsRight, nObjectsRight, pTree,pRoot, 2, rightBox, nObjectsLeft, nAxis2 );
            pTree->SetSplitAxes( pRoot, nAxis0, nAxis1, nAxis2 );

            uint32 nDepth = 1 + std::max( nDepthLeft, nDepthRight );
    ...
    //=====================================================================================================================
    template< class ObjectSet_T, class CostFunction_T >
    void SahAABBTreeBuilder<ObjectSet_T, CostFunction_T>::SetupObjectInfo( ObjectSet* pObjects, std::vector<Object>& objects, 
    ...
    //=====================================================================================================================
    template< class ObjectSet_T, class CostFunction_T >
    int SahAABBTreeBuilder<ObjectSet_T, CostFunction_T>::SplitObjects( Object** objectsByAxis[3],
                                                       ...
                                                       AxisAlignedBox& rRightBox )
    {
        ...
        for( int axis=0; axis<3; axis++ )
        {
            ...
            if( axis == 0 )
                fBestCost = fTotalCost; // we now have the sum of the object ISect costs.  Use that as the 'no-split' cost
    ...
    //=====================================================================================================================
    template< class ObjectSet_T, typename CostFunction_T >
    template< class AABBTree_T >
    uint32 SahAABBTreeBuilder<ObjectSet_T,CostFunction_T>::BuildRecurse( Object** objectsByAxis[3], obj_id nObjects, AABBTree_T* pTree, 
                                                                          ...
                                                                          const AxisAlignedBox& rBox, obj_id nFirstObject )
    {
        ...
        int nSplitAxis = SplitObjects( objectsByAxis, rBox, nObjects, objectsRight, nObjectsLeft, nObjectsRight, leftBox, rightBox );
        if( nSplitAxis != -1 )
        {
            ...
            uint32 nDepthLeft = BuildRecurse( objectsByAxis, nObjectsLeft, pTree, pLeft, leftBox, nFirstObject );
            uint32 nDepthRight = BuildRecurse( objectsRight, nObjectsRight, pTree, pRight, rightBox, nFirstObject + nObjectsLeft );

            return 1 + std::max( nDepthLeft, nDepthRight );
        }
        else
        {
    ...
    uint32 SahAABBTreeBuilder<ObjectSet_T,CostFunction_T>::BuildQAABBRecurse_Even( Object** objectsByAxis[3], obj_id nObjects, QAABBTree_T* pTree, 
                                                                                    ...
                                                                                    const AxisAlignedBox& rBox, obj_id nFirstObject )
    {
        ...
        obj_id nObjectsRight;
        Object** objectsRight[3];
        int nAxis0 =  SplitObjects( objectsByAxis, rBox, nObjects, objectsRight, nObjectsLeft, nObjectsRight, leftBox, rightBox );
        if( nAxis0 != -1 )
        {
            ...
            uint32 nAxis1, nAxis2;
            uint32 nDepthLeft = BuildQAABBRecurse_Odd( objectsByAxis, nObjectsLeft, pTree, pLeaf, 0, leftBox, nFirstObject, nAxis1 );
            uint32 nDepthRight = BuildQAABBRecurse_Odd( objectsRight, nObjectsRight, pTree, pLeaf, 2, rightBox, nFirstObject + nObjectsLeft, nAxis2 );
    ...
    template< class ObjectSet_T, typename CostFunction_T >
    template< class QAABBTree_T >
    uint32 SahAABBTreeBuilder<ObjectSet_T,CostFunction_T>::BuildQAABBRecurse_Odd( Object** objectsByAxis[3], obj_id nObjects, QAABBTree_T* pTree, 
                                                                                   typename QAABBTree_T::NodeHandle pNode,
                                                                                   uint32 nChild,
                                                                                   const AxisAlignedBox& rBox, obj_id nFirstObject, uint32& rSplitAxis )
    {
        ...
        int nAxis =  SplitObjects( objectsByAxis, rBox, nObjects, objectsRight, nObjectsLeft, nObjectsRight, leftBox, rightBox );
        if( nAxis != -1 )
        {
            ...
            uint32 nDepth1 = BuildQAABBRecurse_Even( objectsByAxis, nObjectsLeft, pTree, pNode, nChild, leftBox, nFirstObject );
            uint32 nDepth2 = BuildQAABBRecurse_Even( objectsRight, nObjectsRight, pTree, pNode, nChild+1, rightBox, nFirstObject+nObjectsLeft );
            rSplitAxis = nAxis;
            return std::max(nDepth1,nDepth2);
        }
        else
        {
