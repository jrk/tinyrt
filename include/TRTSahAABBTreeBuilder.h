...
namespace TinyRT
{
    ...
    private:
        ...
        int SplitObjects( Object** objectsByAxis[3],
        ...
        uint32 BuildRecurse( Object** objectsByAxis[3],
                             obj_id nObjects,
                             AABBTree_T* pTree,
        ...
        uint32 BuildQAABBRecurse_Even( Object** objectsByAxis[3],
                                  obj_id nObjects,
                                  QAABBTree_T* pTree,
        ...
        template< typename QAABBTree_T >
        uint32 BuildQAABBRecurse_Odd( Object** objectsByAxis[3],
                                  obj_id nObjects,
                                  QAABBTree_T* pTree,
                                  typename QAABBTree_T::NodeHandle pNode,
                                  uint32 nChild,
